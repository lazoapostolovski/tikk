...
public class Huffman {
  ...
  public void testCodeAndDecodeMessage(){
    ...
    System.out.println("Message length: " + message.getBytes().length * 8 + " bits");
    ...
    System.out.println("Codded message length: " + coddedMessage.length() + " bits");
  ...
  @Test
  public void makeCharFrequency(){
    Map<Character, Double> frequencyMap = new HashMap<Character, Double>();

    String message = getSomeRealTextMessageForAnalize();
...
//    System.out.println("Message length: " + message.length());
    ...
    for(Character ch : frequencyMap.keySet()){
      ...
      frequencyMap.put(ch, percents);
      totalPercents = totalPercents + percents;
//      System.out.println("" + ch + ": " + frequencyMap.get(ch));
    }

//    System.out.println("Total percents: " + totalPercents);

  }

  private void printList(List<CharItem> list){
    for(CharItem charCode : list){
      if(charCode.getCode() == null){
        charCode.setCode("");
      }
//      System.out.println(charCode.getCh() + " " + charCode.getWeight() + " " + charCode.getCode());
    }
  }
...
//
//    chList.add(CharItem.with('e', 25d));
//    chList.add(CharItem.with(' ', 15d));
//    chList.add(CharItem.with('n', 15d));
//    chList.add(CharItem.with('d', 10d));
//    chList.add(CharItem.with('r', 10d));
//    chList.add(CharItem.with('s', 10d));
//    chList.add(CharItem.with('a', 5d));
//    chList.add(CharItem.with('k', 5d));
//    chList.add(CharItem.with('p', 5d));
  }

  private String getSomeRealTextMessageForAnalize(){
